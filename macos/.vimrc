...
hi User1 ctermbg=235 ctermfg=white guibg=black guifg=white
hi User2 ctermbg=235 ctermfg=white guibg=lightgreen guifg=black
hi User3 ctermbg=235 ctermfg=darkblue guibg=black guifg=lightblue
hi User4 ctermbg=235 ctermfg=darkgreen guibg=black guifg=lightgreen
hi User5 ctermbg=235 ctermfg=white guibg=black guifg=magenta
